...
- [Press interactions (issue #120)](project_press_interactions.md) — key-preview-balloon identifier, gesture-on-main + background-query observer for transient UI, cap-release commit test
