...
en-US.json's "More" panel diacritics row (row 2 of More since the #41 main-panel restructure) carries five combining diacritics for General American narrow transcription (issue #15). Code points verified against the Unicode UCD (util.unicode.org character.jsp + NamesList.txt IPA annotations):
...
**Why:** these are the five GA allophonic processes named in Ladefoged & Johnson, *A Course in Phonetics* (English allophone rules), corroborated by UAlberta Ling 205 allophone summary (sites.ualberta.ca/~tnearey/Ling205/Week4/AllophoneSummary.pdf), SFU transcription guides, and Ball et al., "Advanced Phonetic Transcription" (ASHA, doi 10.1044/cicsd_36_F_103).

Issue #29 later appended four *spacing* modifier letters to the same row (same Ladefoged & Johnson GA rules: aspiration, anticipatory rounding, lateral/nasal plosion): ʰ U+02B0 "aspirated", ʷ U+02B7 "labialized", ˡ U+02E1 "lateral release", ⁿ U+207F "nasal release" (ⁿ is in Superscripts and Subscripts, not Spacing Modifier Letters — easy trap). Locked by ToneAndSpacingModifierTests.
